...
class JupiterSemanticReadinessJobTests(unittest.TestCase):
    ...
    def test_approved_merge_finalizes_one_counted_unified_dataset(self) -> None:
        ...
        self.assertIn('READINESS_MERGE_OMIT_EMBEDDING_ARRAYS="1"', script)
    ...
    def test_keyword_sections_are_globally_repartitioned_before_resubmission(self) -> None:
        ...
        self.assertIn("READINESS_MERGE_OMIT_EMBEDDING_ARRAYS", merge_job)
        self.assertIn("--omit-embedding-arrays", merge_job)
