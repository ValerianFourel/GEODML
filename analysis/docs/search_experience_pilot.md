...
which also warns that static YaRN can affect shorter inputs. The model card uses
the legacy `type` spelling; vLLM 0.28 requires `rope_type` in an HF override.
